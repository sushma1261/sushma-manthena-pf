...
const Skills = forwardRef<HTMLElement>((props, ref) => {
  ...
  const MarqueeCards = () => (
    <div
      ...
      className="flex overflow-x-auto w-full select-none mask-linear-fade group py-8 scrollbar-hide"
  ...
  return (
    <section ref={ref} id="skills" className="overflow-hidden py-20">
      <div
        className="container mx-auto px-4 md:px-6 section-scroll opacity-0"
        ref={contentRef}
      >
