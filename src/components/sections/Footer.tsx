  ...
  return (
    ...
    >
      <div className="max-w-4xl mx-auto px-6 text-center space-y-8">
        ...
        <div className="flex justify-center items-center gap-2 text-base text-muted-foreground pt-6">
          <MapPin className="h-5 w-5" />
          <span>{contactData.location}</span>
        </div>

        <div className="pt-12 text-sm text-muted-foreground border-t border-gray-200 dark:border-gray-700">
          <p>
